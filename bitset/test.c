...
int runner_main(void)
{
	...
	asserter_crash_if_not_equal(bitset_add(bitset_empty(), 0xFFFFU), bitset_empty(), __LINE__);
	...
	asserter_crash_if(bitset_contains(bitset_add(bitset_empty(), 1), 0), __LINE__);
